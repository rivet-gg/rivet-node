...
export const FindMatchmakerLobbyForPartyRequest: core.serialization.ObjectSchema<
    serializers.party.activity.FindMatchmakerLobbyForPartyRequest.Raw,
    Rivet.party.activity.FindMatchmakerLobbyForPartyRequest
...
export declare namespace FindMatchmakerLobbyForPartyRequest {
    interface Raw {
        game_modes: string[];
        regions?: string[] | null;
