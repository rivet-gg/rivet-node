...
export const GetBansOutput: core.serialization.ObjectSchema<
    serializers.group.GetBansOutput.Raw,
    Rivet.group.GetBansOutput
...
export declare namespace GetBansOutput {
    interface Raw {
