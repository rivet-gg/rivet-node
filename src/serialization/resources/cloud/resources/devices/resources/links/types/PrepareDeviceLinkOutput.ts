...
export const PrepareDeviceLinkOutput: core.serialization.ObjectSchema<
    serializers.cloud.devices.PrepareDeviceLinkOutput.Raw,
    Rivet.cloud.devices.PrepareDeviceLinkOutput
...
export declare namespace PrepareDeviceLinkOutput {
    interface Raw {
