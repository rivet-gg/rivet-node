...
export const ValidateGameNamespaceMatchmakerConfigRequest: core.serialization.ObjectSchema<
    serializers.cloud.games.namespaces.ValidateGameNamespaceMatchmakerConfigRequest.Raw,
    Rivet.cloud.games.namespaces.ValidateGameNamespaceMatchmakerConfigRequest
