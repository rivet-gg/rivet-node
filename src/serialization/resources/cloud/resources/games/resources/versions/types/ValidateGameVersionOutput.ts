...
export const ValidateGameVersionOutput: core.serialization.ObjectSchema<
    serializers.cloud.games.ValidateGameVersionOutput.Raw,
    Rivet.cloud.games.ValidateGameVersionOutput
