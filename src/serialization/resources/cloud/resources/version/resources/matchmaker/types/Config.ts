...
> = core.serialization.object({
    gameModes: core.serialization.property(
        ...
        core.serialization
            .record(
                ...
                core.serialization
                    .lazyObject(async () => (await import("../../../../../../..")).cloud.version.matchmaker.GameMode)
                    .optional()
            )
            .optional()
    ),
    ...
    regions: core.serialization
        .record(
            core.serialization.string(),
            core.serialization
                .lazyObject(async () => (await import("../../../../../../..")).cloud.version.matchmaker.GameModeRegion)
                .optional()
        )
        .optional(),
...
export declare namespace Config {
    interface Raw {
        game_modes?: Record<string, serializers.cloud.version.matchmaker.GameMode.Raw | null | undefined> | null;
