...
export const GetInvoicesListResponse: core.serialization.ObjectSchema<
    serializers.cloud.GetInvoicesListResponse.Raw,
    Rivet.cloud.GetInvoicesListResponse
...
export declare namespace GetInvoicesListResponse {
    interface Raw {
