...
export const GetGroupPaymentsListResponse: core.serialization.ObjectSchema<
    serializers.cloud.GetGroupPaymentsListResponse.Raw,
    Rivet.cloud.GetGroupPaymentsListResponse
...
export declare namespace GetGroupPaymentsListResponse {
    interface Raw {
