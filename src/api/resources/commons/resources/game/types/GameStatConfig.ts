...
export interface GameStatConfig {
  recordId: string;
  iconId: string;
  format: RivetRivet.commons.GameStatFormatMethod;
  aggregation: RivetRivet.commons.GameStatAggregationMethod;
  sorting: RivetRivet.commons.GameStatSortingMethod;
  priority: number;
