...
export class Cdn {
    ...
    public async listGameCdnSites(
    ...
    ): Promise<Rivet.cloud.games.ListGameCdnSitesResponse> {
        ...
        if (_response.ok) {
            return await serializers.cloud.games.ListGameCdnSitesResponse.parseOrThrow(_response.body, {
    ...
    public async createGameCdnSite(
        gameId: string,
        request: Rivet.cloud.games.CreateGameCdnSiteRequest,
        requestOptions?: Cdn.RequestOptions
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            body: await serializers.cloud.games.CreateGameCdnSiteRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        });
        if (_response.ok) {
            return await serializers.cloud.games.CreateGameCdnSiteResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
