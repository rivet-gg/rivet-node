...
export class Logs {
     ...
     */
    public async getRayPerfLogs(
        rayId: string,
        requestOptions?: Logs.RequestOptions
    ): Promise<Rivet.cloud.GetRayPerfLogsResponse> {
        ...
        if (_response.ok) {
            return await serializers.cloud.GetRayPerfLogsResponse.parseOrThrow(_response.body, {
