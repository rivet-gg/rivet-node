...
export class Client {
     ...
     *
     */
    public async connected(request: RivetApi.matchmaker.PlayerConnectedInput): Promise<void> {
        const _response = await core.fetcher({
            ...
            body: await serializers.matchmaker.players.connected.Request.json({
     ...
     */
    public async disconnected(request: RivetApi.matchmaker.PlayerDisconnectedInput): Promise<void> {
        const _response = await core.fetcher({
            url: urlJoin(
                (this.options.environment ?? environments.RivetApiEnvironment.Production).Matchmaking,
            ...
            body: await serializers.matchmaker.players.disconnected.Request.json({
                playerToken: request.playerToken,
            }),
        });
        if (_response.ok) {
